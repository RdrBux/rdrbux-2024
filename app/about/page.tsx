	...
	return (
		<main className="max-w-3xl mx-auto">
			...
			<div className="text-gray-300 font-normal mt-8">
				...
				<p className="mt-4">Utilizo tecnologías como <b>HTML, CSS, JavaScript, TypeScript, React, Next.js, Node.js, Tailwind</b> y herramientas de diseño como <b>Figma e Illustrator</b> para llevar mis diseños a la realidad.</p>
