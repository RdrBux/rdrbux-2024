...
export default function LangSelector() {
	...
	return (
		<div ref={menu} className="relative">
			...
			{
				showMenu && (
					<div className="rounded-lg p-1 bg-zinc-950 absolute left-0 right-0 -top-[5.5rem] shadow">
						<ul className="flex flex-col gap-1">
							<li>
								<button className="text-sm rounded-lg w-full hover:bg-white/10 px-4 py-2 flex items-center gap-3">
									<img className="w-5" src="español.png" alt="Bandera de España" />
									Español
