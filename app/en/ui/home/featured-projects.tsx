	...
	return (
		<section className="mt-36 flex flex-col gap-6 items-center">
			<div className="text-sm flex gap-3 justify-center items-center">
				...
				<div className="whitespace-nowrap text-gray-300 font-light">Selected Work</div>
			...
			<Link href="/en/projects/saber-supercomplejo" className="overflow-hidden rounded-2xl border-4 border-white/20">
			...
			<Link href="/en/projects/ballena-blanca" className="overflow-hidden rounded-2xl border-4 border-white/20">
			...
			<Link href="/en/projects/dulcinea" className="overflow-hidden rounded-2xl border-4 border-white/20">
			...
			<div className="mt-8 h-12 w-64 rounded-lg relative overflow-hidden bg-white/10">
				...
				<Link href="/en/projects" className="absolute inset-[1px] rounded-lg bg-gray-950 hover:bg-gray-900 duration-200 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.2),inset_0_12px_24px_0_rgba(255,255,255,0.05)]"><div className="w-full h-full grid place-content-center rounded-lg">More projects</div></Link>
			</div>
