	...
	return (
		<footer className="mt-16 flex justify-between items-center border-t border-white/10 py-1">
			...
			<ul className="flex items-center">
				...
				<li>
					<a target="_blank" rel="noopener noreferrer" title="Résumé" aria-label="Résumé" href="https://drive.google.com/file/d/11GrA9lsIslOnRc3Fw4OTEpNpcuqpsjXs/view" className="text-white/60 hover:text-white duration-200 p-2.5 inline-block">{Identification}</a>
				</li>
			</ul>
