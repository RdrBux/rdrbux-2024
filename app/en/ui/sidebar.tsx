	...
	return (
		<div className="hidden lg:block fixed top-0 left-0 h-screen bg-white/5 border-r border-white/10 overflow-hidden">
			...
			<aside className="flex flex-col gap-12 px-4 py-6 h-full">
				<Link href="/en" className="grid grid-cols-[auto_1fr] items-center gap-2">
					<Avatar />
				...
				<ul className="flex flex-col gap-1 text-sm">
					<h5 className="text-white/60 font-medium text-xs mx-3 my-1 uppercase tracking-wider">Contact</h5>
					<li>
				...
				<div className="mt-auto">
					<h5 className="text-white/60 font-medium text-xs mx-3 my-1 uppercase tracking-wider">Language</h5>
					<LangSelector />
				</div>
